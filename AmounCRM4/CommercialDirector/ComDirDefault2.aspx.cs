...
{
    public partial class ComDirDefault2 : System.Web.UI.Page
    {
        ...
        protected void FillCallsHeader()
        {
                ...
                //lB.Text = "Class B: " + ((DataView)ListOfCallsDS.Select(DataSourceSelectArguments.Empty)).ToTable().Select("PhysicianClass = 'B'").Length.ToString();
