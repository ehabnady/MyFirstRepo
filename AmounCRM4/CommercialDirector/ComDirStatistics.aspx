<%@ Page Title="Calls Analysis" Language="C#" MasterPageFile="~/CommercialDirector/SiteMaster2.Master" AutoEventWireup="true" CodeBehind="ComDirStatistics.aspx.cs" Inherits="AmounCRM4.CommercialDirector.ComDirStatistics" %>
                    ...
                    <telerik:RadAjaxPanel ID="ajaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Width="100%">
                        <telerik:RadPivotGrid ID="RadPivotGrid1" runat="server" RenderMode="Lightweight" Width="100%" Height="700px" DataSourceID="ObjectDataSource21"
                            ...
                            <Fields>
                                ...
                                <telerik:PivotGridReportFilterField Caption="Line" DataField="LineName" SortOrder="Ascending" UniqueName="LineName">
                                </telerik:PivotGridReportFilterField>
                                ...
                                <telerik:PivotGridReportFilterField Caption="Sales Director" DataField="DirectorName" SortOrder="Ascending" UniqueName="DirectorName">
                                </telerik:PivotGridReportFilterField>
                                ...
                                <telerik:PivotGridColumnField Caption="Brand" DataField="BrandName" SortOrder="Ascending" UniqueName="BrandName">
                                </telerik:PivotGridColumnField>
