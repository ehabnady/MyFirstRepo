...
{
    public partial class SpecValueForm : System.Web.UI.Page
    {
        ...
        protected void grdDetailingTemp_InsertCommand(object sender, GridCommandEventArgs e)
        {
            try
            {
                ...
                dsTempSaving.InsertParameters[1].DefaultValue = ((RadDropDownList)(insertedItem["SpecialityCode"].Controls[1])).SelectedValue;
                dsTempSaving.InsertParameters[2].DefaultValue = ((TextBox)(insertedItem["SpecValue"].Controls[1])).Text;
        ...
        protected void grdDetailingTemp_UpdateCommand(object sender, GridCommandEventArgs e)
        {
            try
            {
                ...
                dsTempSaving.UpdateParameters[2].DefaultValue = ((RadDropDownList)(editedItem["SpecialityCode"].Controls[1])).SelectedValue;
                dsTempSaving.UpdateParameters[3].DefaultValue = ((TextBox)(editedItem["SpecValue"].Controls[1])).Text;
                if ((((CheckBox)(editedItem["Deleted"].Controls[1])).Checked).ToString() == "True")
                {
                    dsTempSaving.UpdateParameters[4].DefaultValue = Boolean.TrueString;
                }
                else
                {
                    dsTempSaving.UpdateParameters[4].DefaultValue = Boolean.FalseString;
                }
