...
{
    public partial class ComDirReport_Dashboard : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //ada1.FillByComDir(apps, int.Parse(Session["EmployeeIDFromComDir"].ToString()), int.Parse(Session["CycleIDFromComDir"].ToString()));
            ada1.FillByComDir(apps, int.Parse(Session["CycleIDFromComDir"].ToString()));
            ...
            ada2.FillByComDir(affs, int.Parse(Session["CycleIDFromComDir"].ToString()));
