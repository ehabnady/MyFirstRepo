<%@ Page Title="Calls Analysis" Language="C#" MasterPageFile="~/SalesDirector/SiteMaster2.Master" AutoEventWireup="true" CodeBehind="CallsAnalysis.aspx.cs" Inherits="AmounCRM4.SalesDirector.CallsAnalysis" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    ...
    <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetDataBySD"
        ...
        <SelectParameters>
            <asp:SessionParameter Name="EmployeeIDFromDir" Type="Int32" SessionField="EmployeeIDFromDir" />
        </SelectParameters>
