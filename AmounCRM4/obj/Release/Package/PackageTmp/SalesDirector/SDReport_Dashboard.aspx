<%@ Page Title="Dashboard" Language="C#" MasterPageFile="~/SalesDirector/SiteMaster2.Master" AutoEventWireup="true" 
    CodeBehind="SDReport_Dashboard.aspx.cs" Inherits="AmounCRM4.SalesDirector.SDReport_Dashboard" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
                            ...
                            <telerik:RadAjaxPanel ID="ajaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Width="100%">
                                <telerik:RadPivotGrid ID="RadPivotGrid1" runat="server" RenderMode="Auto" Width="100%" Height="700px" DataSourceID="ObjectDataSource2"
                                    ...
                                    <Fields>
                                        ...
                                        <telerik:PivotGridReportFilterField Caption="IsMandatory" DataField="IsTargeted2" UniqueName="IsTargeted2">
                                        </telerik:PivotGridReportFilterField>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetDataBySD"
        TypeName="AmounCRM4.App_Data.ExecSummary2TableAdapters.View3_FullViewTableAdapter" OnSelected="ObjectDataSource2_Selected">
        <SelectParameters>
            <asp:SessionParameter Name="EmployeeIDFromSD" SessionField="EmployeeIDFromDir" Type="Int32" />
            <asp:SessionParameter Name="CycleIDFromSD" SessionField="CycleIDFromDir" Type="Int32" />
        </SelectParameters>
