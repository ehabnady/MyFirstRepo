<%@ Page Title="Calls Analysis" Language="C#" MasterPageFile="~/CommercialDirector/SiteMaster2.Master" AutoEventWireup="true" CodeBehind="CallsAnalysis.aspx.cs" Inherits="AmounCRM4.CommercialDirector.CallsAnalysis" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    ...
    <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetDataActualVsTargetCalls_ECMS"
