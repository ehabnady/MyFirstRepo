<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="DMReport_Affiliations.aspx.cs" Inherits="AmounCRM4.DMs.DMReport_Affiliations" %>
            ...
            <td align="center">
                ...
                <telerik:RadAjaxPanel ID="ajaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Width="96%" HorizontalAlign="Center">
                    ...
                    <asp:SqlDataSource ID="ListOfAffDS" runat="server" ConnectionString="<%$ ConnectionStrings:AmounCrmConnectionString %>"
                        SelectCommand="SELECT AffiliationID, AffiliationName, EntityAddress, SpecialityCode, PhysicianClass, AmounTerritoryName, IsTargeted FROM View_Affiliations_Admin WHERE SpecialtyValue > 0 AND SupervisorID = @EmployeeIDFromDM">
                        <SelectParameters>
                            <asp:SessionParameter Name="EmployeeIDFromDM" SessionField="EmployeeIDFromDM" Type="Int32" />
                        </SelectParameters>
                    </asp:SqlDataSource>

                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetDataBySupervisionAreaID2" TypeName="AmounCRM4.App_Data.ExecSummary2TableAdapters.AffiliationsByAreaGroupBySpecTableAdapter">
                        <SelectParameters>
                            <asp:SessionParameter Name="EmployeeIDFromDM" SessionField="EmployeeIDFromDM" Type="Int32" />
                        </SelectParameters>
