<%@ Page Title="Calls Analysis" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="CallsAnalysis.aspx.cs" Inherits="AmounCRM4.DMs.CallsAnalysis" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    ...
    <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetDataBySupervisorID"
        TypeName="AmounCRM4.App_Data.ExecSummary2TableAdapters.ActualVsTargetCalls_ECMSTableAdapter">
        <SelectParameters>
            <asp:SessionParameter Name="EmployeeIDFromDM" Type="Int32" SessionField="EmployeeIDFromDM" />
        </SelectParameters>
