<%@ Page Title="Reps Plans" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="DMCallsScheduler.aspx.cs" Inherits="AmounCRM4.DMs.DMCallsScheduler" %>
    ...
    <div>
        <asp:Panel ID="searchPanel" runat="server" GroupingText="Calendar" Width="94%" BackColor="LightBlue" Font-Names="Times New Roman" Font-Size="Large"
            ...
            <asp:SqlDataSource ID="dsReps" runat="server" ConnectionString="<%$ ConnectionStrings:AmounCrmConnectionString %>" 
                SelectCommand="SELECT DISTINCT [EmployeeID], [EmployeeFullName] FROM [View_Employees] WHERE ([DirectManagerID] = @EmployeeID) AND (DeletedEmployee IS NULL OR DeletedEmployee = 0) ORDER BY [EmployeeFullName]">
                <SelectParameters>
