<%@ Page Title="Notifications" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="Notifications.aspx.cs" Inherits="AmounCRM4.DMs.Notifications" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
            ...
            <div visible="true" align="center">
                ...
                <asp:SqlDataSource runat="server" ID="sqlDSVac" ConnectionString='<%$ ConnectionStrings:AmounCrmConnectionString %>' 
                    SelectCommand="SELECT [Vaccation Name] AS Vaccation_Name, [VaccationDate], [CycleID] FROM [NationalVaccations] WHERE ([CycleID] = @CycleIDFromDM)">
                    <SelectParameters>
                        <asp:SessionParameter SessionField="CycleIDFromDM" Name="CycleIDFromDM" Type="Int32"></asp:SessionParameter>
                    </SelectParameters>
                </asp:SqlDataSource>
            </div>
    ...
    <table width="95%">
        <tr>
            <td valign="top" align="center">
                ...
                <asp:GridView runat="server" ID="myID2" DataSourceID="SqlDataSource1" GridLines="Both" CellPadding="5" CellSpacing="5" ForeColor="#333333" HorizontalAlign="Center" OnRowDataBound="myID2_RowDataBound">
        ...
        <tr>
            <td valign="top" align="center">
                <asp:Label ID="lblTitle2" runat="server" Text="Messages" Font-Bold="true"></asp:Label><br /><br />
                ...
                <asp:SqlDataSource runat="server" ID="sqlDS_Messages" ConnectionString='<%$ ConnectionStrings:AmounCrmConnectionString %>' 
                    SelectCommand="SELECT [CRM_MessageID], [CRM_MessageName], [CRM_MessageDescription], [CRM_MessageTypeName], [StartDate], [EndDate], [LineID], [SalesManagerID], [DistrictManagerID], [SalesRepID] FROM [View_CRM_Messages] WHERE ((([LineID] = 14) OR ([DistrictManagerID] = @EmployeeIDFromDM)) AND EndDate >= GETDATE())">
                    <SelectParameters>
                        <asp:SessionParameter SessionField="EmployeeIDFromDM" Name="EmployeeIDFromDM" Type="Int32" DefaultValue="760"></asp:SessionParameter>
                    </SelectParameters>
                </asp:SqlDataSource>
            </td>
        </tr>
