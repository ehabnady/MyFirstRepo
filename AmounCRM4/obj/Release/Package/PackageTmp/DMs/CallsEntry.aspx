<%@ Page Title="Sales Calls" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="CallsEntry.aspx.cs" Inherits="AmounCRM4.DMs.CallsEntry" %>
            ...
            <asp:TemplateField HeaderText="Product" HeaderStyle-HorizontalAlign="Left">
                <ItemTemplate>
                    ...
                    <asp:SqlDataSource ID="ProductDS" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:AmounCrmConnectionString %>" 
                        SelectCommand="SELECT DISTINCT BrandID, BrandName, BrandPriority FROM [View_BrandPriorityBySpecLine] WHERE (LineID = @LineIDFromDM AND SpecialtyID = @SpecialtyID AND BrandPriority < 5) Order By BrandPriority">
                        <SelectParameters>
                            <asp:SessionParameter Name="LineIDFromDM" SessionField="LineIDFromDM" />
