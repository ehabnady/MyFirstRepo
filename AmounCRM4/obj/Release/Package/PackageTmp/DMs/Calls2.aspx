<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Calls2.aspx.cs" Inherits="AmounCRM4.DMs.Calls2" 
                ...
                <asp:TableCell ID="TableCell10" runat="server">
                    ...
                    <asp:SqlDataSource runat="server" ID="dsDoubleVisitManagers" ConnectionString='<%$ ConnectionStrings:AmounCrmConnectionString %>' 
                        SelectCommand="Select 1 as DirectManagerID, 'None' as DirectManagerName, 0 as TypeID
                                        union
                                        Select DirectManagerID, DirectManagerName, 2 as TypeID From View_Employees Where EmployeeID = @EmployeeIDFromDM
                                        union 
                                        Select EmployeeID, EmployeeFullName, 1 as TypeID From View_Employees Where EmployeeID = @EmployeeIDFromDM Order By TypeID">
                        <SelectParameters>
                            <asp:SessionParameter SessionField="EmployeeIDFromDM" Name="EmployeeIDFromDM"></asp:SessionParameter>
                        </SelectParameters>
                    </asp:SqlDataSource>
                </asp:TableCell>
