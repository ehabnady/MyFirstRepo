<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RepAffiliationForm1.aspx.cs" Inherits="AmounCRM4.Admins.RepAffiliationForm1"   MasterPageFile="~/Site1.Master" %>
...
<asp:Content ID="Body" runat="server" ContentPlaceHolderID="Body">
    <div>
        ...
        <span class="auto-style81"><strong>DB Request</strong></span><strong style="text-align: left">
        ...
        <table  dir="ltr" style="table-layout: fixed">
            <tr>
                ...
                <div style="width: 100%; height: 200px; overflow: auto">
                    ...
                    <asp:GridView ID="gvAffiliations" runat="server" OnSelectedIndexChanged="gvAffiliations_SelectedIndexChanged" OnRowCreated="gvAffiliations_RowCreated" 
        ...
        <asp:Panel ID="Panel1" runat="server">
            <table  dir="ltr" style="table-layout: fixed; width: 769px;">
                <tr>
                    <td class="auto-style105">
                        Doctor Name
                        </td>
                        <td class="auto-style104" colspan="2"><strong style="text-align: left">
                        <asp:TextBox ID="txtAffiliationName" runat="server" Width="366px" BackColor="#5D7B9D" BorderStyle="None" Enabled="False" ForeColor="Black" style="font-size: small"></asp:TextBox>
                        </strong></td>
                ...
                <tr>
                    <td class="auto-style196" > <span class="auto-style186"><strong><span class="auto-style192">Clinic</span></strong></span><strong><span class="auto-style189"> Name</span></strong></td>
                        <td class="auto-style164"><strong style="text-align: left">
                            ...
                            <asp:Label ID="lblEntityReq" runat="server" ForeColor="Red" Height="16px" Text="*" Visible="False" Width="16px"></asp:Label>
                            </strong></td>
                ...
                <tr>
                    ...
                    <td class="auto-style178"><strong><span class="auto-style106">Entity Type</span><br class="auto-style106" /> </strong>
                ...
                <tr>
                    ...
                    <td class="auto-style196">No Of Patients<br />
                        <asp:Label ID="lblNoOfPatientsOld" runat="server" style="color: #666666" Text="Current No.Of Patients" Visible="False"></asp:Label>
                    </td>
                    <td class="auto-style164">
                        <asp:DropDownList ID="ddlNoOfPatients" runat="server" Width="169px" AppendDataBoundItems="True" DataSourceID="NoOfPatDataSource" DataTextField="RangeName" DataValueField="RangeValue" >
                            <asp:ListItem Value="0">Select</asp:ListItem>
                        </asp:DropDownList>
                    ...
                    <td class="auto-style163">Waiting Time<br />
                ...
                <tr>
                    <td class="auto-style197">Tel 1</td>
                    <td class="auto-style200">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td style="background-color: #F7F6F3">
                        <asp:RadioButton ID="cbimplemented" runat="server" GroupName="Admin" OnCheckedChanged="RadioButton1_CheckedChanged1" Text="Approved" CssClass="auto-style186" AutoPostBack="True" />
                        <asp:RadioButton ID="cbNotImplement" runat="server" GroupName="Admin" OnCheckedChanged="cbNotImplement_CheckedChanged" Text="Rejected" CssClass="auto-style186" AutoPostBack="True" />
                    </td>
                    <td style="background-color: #F7F6F3" >
                        <asp:TextBox ID="txtAdminName" runat="server" Width="143px" CssClass="auto-style186" Enabled="False"></asp:TextBox>
                        <asp:TextBox ID="txtAdminDate" runat="server" Enabled="False" Width="73px"></asp:TextBox>
                    </td>
                    <td style="background-color: #F7F6F3" class="auto-style1">
                        <asp:TextBox ID="txtAdminComments" runat="server" TextMode="MultiLine" CssClass="auto-style186" ></asp:TextBox>
                        <asp:Label ID="lblAdminCommentReq" runat="server" ForeColor="Red" Text="*" CssClass="auto-style186"></asp:Label>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                                    <td class="auto-style189" ><strong>Commercial Manager</strong></td>
                                    <td style="background-color: #F7F6F3">
        ...
        <asp:SqlDataSource ID="PhysicianDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:AmounCrmConnectionString %>" 
            SelectCommand="SELECT PhysicianID, PhysicianName FROM Physicians">
        </asp:SqlDataSource>
        <asp:SqlDataSource ID="EntityDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:AmounCrmConnectionString %>" 
            SelectCommand="SELECT EntityID, EntityName FROM Entities">
        </asp:SqlDataSource>
        ...
        <asp:SqlDataSource ID="AreaDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:AmounCrmConnectionString %>" 
            SelectCommand="SELECT AmounBrickID, AmounBrickName FROM View_EmployeesBricks WHERE (Deleted IS NULL) OR (Deleted = 0)">
        </asp:SqlDataSource>
        ...
        <asp:SqlDataSource ID="EntityTypeDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:AmounCrmConnectionString %>" 
            SelectCommand="SELECT EntityTypeID, EntityTypeName, Deleted FROM EntityTypes WHERE (Deleted IS NULL)">
        </asp:SqlDataSource>
        ...
        <asp:SqlDataSource ID="SpecialityDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:AmounCrmConnectionString %>" 
            SelectCommand="SELECT DISTINCT BrandPriorityBySpecLine.SpecialtyID, Specialities.Specialitycode FROM BrandPriorityBySpecLine INNER JOIN Specialities ON BrandPriorityBySpecLine.SpecialtyID = Specialities.SpecialityID">
        </asp:SqlDataSource>
