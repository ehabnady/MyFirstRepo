<%@ Page Title="Pharmacies Feedback Reports" Language="C#" MasterPageFile="~/FeedbackSite4.Master" AutoEventWireup="true" CodeBehind="FeedbackReports.aspx.cs" Inherits="AmounCRM4.Surveys.FeedbackReports" %>
                ...
                <telerik:RadPanelItem Text="In-Market Sales by Pharmacy / Product" Expanded="true" Font-Size="Large" Visible="true" Width="100%" BackColor="#5D7B9D" ForeColor="White">
                    <ContentTemplate>
                        ...
                        <asp:SqlDataSource runat="server" ID="dsSales" ConnectionString='<%$ ConnectionStrings:AmounCrmConnectionString %>'
                            SelectCommand="SELECT * FROM [View_PH_FeedbackPharmaciesSales] WHERE ([EmployeeID] = @EmployeeHRCodeFromSales)">
                            <SelectParameters>
                ...
                <telerik:RadPanelItem Text="Frequency of Visits by Pharmacy" Expanded="false" Font-Size="Large" Visible="true" Width="100%" BackColor="#5D7B9D" ForeColor="White">
                    <ContentTemplate>
                        ...
                        <asp:SqlDataSource ID="dsVisitsbyPharmacy" runat="server" ConnectionString="<%$ ConnectionStrings:AmounCrmConnectionString %>"
                            SelectCommand="SELECT [YearID],[MonthID],[PharmacyID],[PharmacyName],[EmployeeID],[EmployeeHRCode],[EmployeeFullName],[VisitsCount] FROM [AmounCRM2].[dbo].[View_PH_Rep_Frequency_Of_Visit_by_Pharmacy] WHERE EmployeeID = @EmployeeIDFromSales">
                            <SelectParameters>
                                <asp:SessionParameter Name="EmployeeIDFromSales" SessionField="EmployeeIDFromSales" Type="Int32" />
                            </SelectParameters>
                        </asp:SqlDataSource>
                    </ContentTemplate>
                </telerik:RadPanelItem>
                ...
                <telerik:RadPanelItem Text="Frequency of Visits by Market" Expanded="false" Font-Size="Large" Visible="true" Width="100%" BackColor="#5D7B9D" ForeColor="White">
                    <ContentTemplate>
                        ...
                        <asp:SqlDataSource ID="dsVisitsbyMarket" runat="server" ConnectionString="<%$ ConnectionStrings:AmounCrmConnectionString %>"
                            SelectCommand="SELECT [YearID],[QuarterID],[MonthID],[CycleID],[CycleDesc],[EmployeeID],[EmployeeHRCode],[EmployeeFullName],[MarketID],[MarketName],[VisitCount] FROM [AmounCRM2].[dbo].[View_PH_Rep_Frequency_Of_Visit_by_Market] WHERE EmployeeID = @EmployeeIDFromSales">
                            <SelectParameters>
                                <asp:SessionParameter Name="EmployeeIDFromSales" SessionField="EmployeeIDFromSales" Type="Int32" />
                            </SelectParameters>
                        </asp:SqlDataSource>
                ...
                <telerik:RadPanelItem Text="Activities" Expanded="false" Font-Size="Large" Visible="true" Width="100%" BackColor="#5D7B9D" ForeColor="White">
                    <ContentTemplate>
                        ...
                        <asp:SqlDataSource ID="dsActivities" runat="server" ConnectionString="<%$ ConnectionStrings:AmounCrmConnectionString %>"
                            SelectCommand="SELECT [YearID],[MonthID],[EmployeeID],[EmployeeHRCode],[EmployeeFullName],[MarketID],[MarketName],[ProductID],[ProductName],(CASE WHEN [IsAmounProduct] = 0 THEN 'No' ELSE 'Yes' END) as IsAmounProduct,[ActivityID],[ActivityName],[Occurence] FROM [AmounCRM2].[dbo].[View_PH_Rep_Activities_By_Product] WHERE EmployeeID = @EmployeeIDFromSales">
                            <SelectParameters>
                                <asp:SessionParameter Name="EmployeeIDFromSales" SessionField="EmployeeIDFromSales" Type="Int32" />
                            </SelectParameters>
                        </asp:SqlDataSource>
