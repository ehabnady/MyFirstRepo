<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="RepsDefault3.aspx.cs" Inherits="AmounCRM4.Reps.RepsDefault3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    ...
    <div style="width:100%">
        <telerik:RadPanelBar runat="server" ID="RadPanelBar1" Width="100%" Height="800px" ExpandMode="FullExpandedItem">
            <Items>
                <telerik:RadPanelItem Text="Actual Vs. Planned Visits" Expanded="true" CssClass="panelItem1" Visible="true" Width="98%">
                    <ContentTemplate>
                ...
                <telerik:RadPanelItem Text="Doctors List" Expanded="false" Font-Size="Large" CssClass="panelItem2" Visible="true" Width="98%">
                    <ContentTemplate>
                ...
                <telerik:RadPanelItem Text="Doctor's Visits / Planned" Expanded="false" Font-Size="Large" CssClass="panelItem3" Visible="true" Width="98%">
                    <ContentTemplate>
                ...
                <telerik:RadPanelItem Text="Call Rate Per Cycle" Expanded="false" Font-Size="Large" CssClass="panelItem4" Visible="true" Width="98%">
                    <ContentTemplate>
                ...
                <telerik:RadPanelItem Text="Not Visited Doctors" Expanded="false" Font-Size="Large" CssClass="panelItem5" Visible="true" Width="98%">
                    <ContentTemplate>
                        <telerik:RadGrid ID="gridNotPlanned" DataSourceID="dsNotVisited" runat="server" AllowFilteringByColumn="True" AllowPaging="True" AllowSorting="True"
                            ...
                            <MasterTableView DataSourceID="dsNotVisited" AutoGenerateColumns="False" ShowHeader="true" ShowGroupFooter="true" AllowPaging="true"
                                AllowSorting="true" CommandItemDisplay="Top" EnableViewState="true">
                                <CommandItemSettings ExportToExcelText="Export" ShowRefreshButton="true" ShowExportToExcelButton="true" ShowAddNewRecordButton="False" />
                                <PagerStyle AlwaysVisible="True" PageSizes="50;100;150;200;300;400;500" Mode="NextPrevAndNumeric" />
                                <Columns>
                ...
                <telerik:RadPanelItem Text="Target / Plan / Visits" Expanded="false" Font-Size="Large" CssClass="panelItem6" Visible="true" Width="98%">
                    <ContentTemplate>
                ...
                <telerik:RadPanelItem Text="Coverage & Frequency Per Cycle" Expanded="false" Font-Size="Large" CssClass="panelItem7" Visible="true" Width="98%">
                    <ContentTemplate>
