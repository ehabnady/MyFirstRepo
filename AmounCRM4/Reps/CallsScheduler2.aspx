<%@ Page Title="Plan with Multiple Selections" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="CallsScheduler2.aspx.cs" Inherits="AmounCRM4.Reps.CallsScheduler2" %>
            ...
            <table width="94%">
                ...
                <tr>
                    ...
                    <td colspan="2">
                        ...
                        <telerik:RadButton ID="btnCopy" runat="server" Text="Copy Day" Height="30px" BackColor="White" CssClass="hiddenButton"
                            Font-Names="Times New Roman" Font-Size="Medium" ForeColor="#0000CC" Visible="true" OnClick="btnCopy_Click">
                        </telerik:RadButton>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="6">
                        <asp:Label ID="lblDoctors2" runat="server" Text="Select Doctors (Multiple Selections):"></asp:Label>
                        <br />
                        <asp:CheckBoxList ID="chklDoctors" runat="server" RepeatDirection="Horizontal" RepeatColumns="5" Visible="false">                            
                        </asp:CheckBoxList>

                        <telerik:RadTreeView ID="tree1" runat="server" CheckBoxes="True" CheckChildNodes="True" Skin="WebBlue" SingleExpandPath="true" 
                            MultipleSelect="true" Height="200" Width="30%">
                        </telerik:RadTreeView>

                        <br />
                        <telerik:RadDropDownTree ID="chklDoctors2" runat="server" ButtonSettings-ShowCheckAll="true" ButtonSettings-ShowClear="true" 
                            CheckBoxes="SingleCheck" DropDownSettings-AutoWidth="Enabled" EnableDirectionDetection="true" EnableTheming="true" Skin="WebBlue" 
                            ExpandNodeOnSingleClick="True" CheckNodeOnClick="true" Enabled="false" Visible="false">
                            <DropDownSettings AutoWidth="Enabled" OpenDropDownOnLoad="True"></DropDownSettings>
                            <ButtonSettings ShowCheckAll="True" ShowClear="true"></ButtonSettings>
                            <FilterSettings Highlight="None" EmptyMessage="Search..."></FilterSettings>
                        </telerik:RadDropDownTree>
                        <br />
                        <p>
                            <asp:Button ID="btnNew2" runat="server" Text="Create New Appointments" OnClick="btnNew2_Click" />
                            <asp:Button ID="btnSearch2" runat="server" Text="Search Appointments For Selected Doctors" OnClick="btnSearch2_Click" />
                        </p>
                    </td>
                </tr>
