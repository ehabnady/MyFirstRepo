<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="AdminAffiliationForm2.aspx.cs" Inherits="AmounCRM4.Admins.AdminAffiliationForm2" %>
    ...
    <div>
        ...
        <table class="auto-style21">
            ...
            <tr>
                ...
                <td class="auto-style111">
                    <asp:DropDownList ID="ddlLine8" runat="server" DataSourceID="PHabitDataSource" DataTextField="ShortName" DataValueField="RangeValue" AppendDataBoundItems="True">
                    <asp:ListItem Value="0">Select</asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                ...
                <td class="auto-style105">
                    <asp:DropDownList ID="ddlNoPatients8" runat="server" DataSourceID="NOPatientsDataSource" DataTextField="RangeName" DataValueField="RangeValue" AppendDataBoundItems="True">
                        <asp:ListItem Value="0">Select</asp:ListItem>
                    </asp:DropDownList>
                    <asp:TextBox ID="txtRecID8" runat="server" Visible="False" Width="68px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                ...
                <td class="auto-style105">
                    <asp:DropDownList ID="ddlWT8" runat="server" DataSourceID="WTDataSource" DataTextField="RangeName" DataValueField="RangeValue">
                        <asp:ListItem Value="0">Select</asp:ListItem>
            ...
            <tr>
                ...
                <td class="auto-style106">No. Of Operations</td>
                <td class="auto-style105">
                    &nbsp;</td>
                <td class="auto-style105">
                    &nbsp;</td>
                ...
                <td class="auto-style105">
                    &nbsp;</td>
                <td class="auto-style105">
                    <asp:DropDownList ID="ddlNoofOps" runat="server" DataSourceID="NoOfOperationsDataSource" DataTextField="RangeName" DataValueField="RangeValue" AppendDataBoundItems="True">
                        <asp:ListItem Value="0">Select</asp:ListItem>
            ...
            <tr>
                ...
                <td colspan="9" class="auto-style105">
                    ...
                    <asp:SqlDataSource ID="NoOfOperationsDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:AmounCrmConnectionString %>" SelectCommand="SELECT [RangeName], [RangeValue] FROM [NoOfOperations]"></asp:SqlDataSource>
