<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="MessageForm2.aspx.cs" Inherits="AmounCRM4.Admins.MessageForm2" %>
    ...
    <asp:Table ID="tblDetail" runat="server" BorderWidth="2px" Width="80%" GridLines="Both" HorizontalAlign="Center"
            ...
            <asp:TableCell ID="td1" runat="server" HorizontalAlign="Left" ColumnSpan="4">
               <%-- <asp:Button ID="btnGetDM" runat="server" OnClick="btnGetDM_Click" Text="Get DMs" />
                ...
                <telerik:RadComboBox RenderMode="Lightweight" ID="RadComboBox1" runat="server" CheckBoxes="true" EnableCheckAllItemsCheckBox="true" 
                    Width="600" Label="Select Sales Managers:" DataSourceID="dsManagers"  DataTextField="EmployeeFullName" DataValueField="EmployeeID" 
                    MaxHeight="5000" OnSelectedIndexChanged="RadComboBox1_OnSelectedIndexChanged" AutoPostBack="true">
        ...
        <asp:TableRow ID="tr2" runat="server">
            <asp:TableCell ID="td3" runat="server" HorizontalAlign="Left" ColumnSpan="4">
                ...
                <br />--%>
                 <telerik:RadComboBox RenderMode="Lightweight" ID="RadComboBox2" runat="server" CheckBoxes="true" EnableCheckAllItemsCheckBox="true" 
                    Width="600" Label="Select District Managers:" MaxHeight="200" OnSelectedIndexChanged="RadComboBox2_OnSelectedIndexChanged" AutoPostBack="true">                   
                </telerik:RadComboBox>
            </asp:TableCell>
        ...
        <asp:TableRow ID="tr3" runat="server">
            <asp:TableCell ID="td5" runat="server" HorizontalAlign="Left" ColumnSpan="4">
                 <telerik:RadComboBox RenderMode="Lightweight" ID="RadComboBox3" runat="server" CheckBoxes="true" EnableCheckAllItemsCheckBox="true" 
                    Width="600" Label="Select Sales Reps:" MaxHeight="200" >                   
                </telerik:RadComboBox>
            </asp:TableCell>
