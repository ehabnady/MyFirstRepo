<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="RepAffiliationFormO.aspx.cs" Inherits="AmounCRM4.Admins.RepAffiliationFormO" %>
            ...
            <tr>
                <td>
                    <div style="width: 100%; height: 200px; overflow: auto" >
                        ...
                        <HeaderStyle BackColor="Coral" Font-Bold="True" ForeColor="White" />
            ...
            <table align="center" dir="ltr" style="table-layout: fixed; width: 769px;">
                <tr>
                    ...
                    <td class="auto-style104" colspan="2"><strong style="text-align: left">
                        <asp:TextBox ID="txtAffiliationName" runat="server" Width="366px" BackColor="Coral" BorderStyle="None" Enabled="False" ForeColor="white" Style="font-size: small"></asp:TextBox>
                    </strong></td>
