...
namespace AmounCRM4.Admins
{
    public partial class MessagesForm : System.Web.UI.Page
    {
        ...
        protected void btnGetDM_Click(object sender, EventArgs e)
        {
            string DMIDs = "9";
            string comText = "";
            ...
            dsDM.DataBind();
            cblDMs.DataSource = dsDM;
            cblDMs.DataValueField = "EmployeeID";
            cblDMs.DataTextField = "EmployeeFullName";
            cblDMs.DataBind();
        }
        protected void btnGetReps_Click(object sender, EventArgs e)
        {
            string RepIDs = "9";
            string comText = "";
            ...
            dsRep.DataBind();
            cblReps.DataSource = dsRep;
            cblReps.DataValueField = "EmployeeID";
            cblReps.DataTextField = "EmployeeFullName";
            cblReps.DataBind();
        }
        ...
        protected void chkAllReps_CheckedChanged(object sender, EventArgs e)
        {
            if (cbAllReps.Checked)
            {
                foreach (ListItem chk in cblReps.Items)
                {
                    chk.Selected = true;
                }
            }
        ...
        protected void chkAllDMs_CheckedChanged(object sender, EventArgs e)
        {
            if (cbAllDMs.Checked)
            {
                foreach (ListItem chk in cblDMs.Items)
                {
                    chk.Selected = true;
                }
            }
        ...
        protected void chkAllSMs_CheckedChanged(object sender, EventArgs e)
        {
            if (cbAllSMs.Checked)
            {
                foreach (ListItem chk in cblManagers.Items)
                {
                    chk.Selected = true;
                }
            }
