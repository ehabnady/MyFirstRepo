<%@ Page Title="Calls Analysis" Language="C#" MasterPageFile="~/SalesDirector/SiteMaster2.Master" AutoEventWireup="true" CodeBehind="SDStatistics.aspx.cs" Inherits="AmounCRM4.SalesDirector.SDStatistics" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
                    ...
                    <telerik:RadAjaxPanel ID="ajaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Width="100%">
                        <telerik:RadPivotGrid ID="RadPivotGrid1" runat="server" RenderMode="Lightweight" Width="100%" Height="700px" DataSourceID="ObjectDataSource21"
                            ...
                            <Fields>
                                ...
                                <telerik:PivotGridReportFilterField Caption="Rep Name" DataField="EmployeeFullName" SortOrder="Ascending" UniqueName="EmployeeFullName">
                                </telerik:PivotGridReportFilterField>
                                <telerik:PivotGridReportFilterField Caption="DM" DataField="DirectManagerName" SortOrder="Ascending" UniqueName="DirectManagerName">
                                </telerik:PivotGridReportFilterField>
                                <telerik:PivotGridReportFilterField Caption="Sales Manager" DataField="TopManagerName" SortOrder="Ascending" UniqueName="TopManagerName">
                                </telerik:PivotGridReportFilterField>
                                ...
                                <telerik:PivotGridReportFilterField Caption="Brand" DataField="BrandName" SortOrder="Ascending" UniqueName="BrandName">
                                </telerik:PivotGridReportFilterField>
                                <telerik:PivotGridReportFilterField Caption="Class" DataField="PhysicianClass" SortOrder="Ascending" UniqueName="PhysicianClass" ZoneIndex="2">
                                </telerik:PivotGridReportFilterField>

                                <telerik:PivotGridColumnField Caption="Line" DataField="LineName" SortOrder="Ascending" UniqueName="LineName" ZoneIndex="1">
                                ...
                                <telerik:PivotGridAggregateField Caption="Target Calls" DataField="TargetCalls" UniqueName="TargetCalls">
                                    <TotalFormat Axis="Rows" Level="2" SortOrder="Ascending" TotalFunction="NoCalculation" />
                                ...
                                <telerik:PivotGridAggregateField Caption="Actual Calls" DataField="CallsCount" UniqueName="CallsCount">
                                    <TotalFormat Axis="Rows" Level="2" SortOrder="Ascending" TotalFunction="NoCalculation" GroupName="TotalCallsCount" />
    ...
    <asp:ObjectDataSource ID="ObjectDataSource21" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetDataByComDir"
        TypeName="AmounCRM4.App_Data.ExecSummary2TableAdapters.View_StatisticesWebViewTableAdapter">
        <SelectParameters>
