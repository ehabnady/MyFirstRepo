...
{
    public partial class SMReport_Dashboard : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ada1.FillByManagerID(apps, int.Parse(Session["CycleIDFromSM"].ToString()), int.Parse(Session["EmployeeIDFromSM"].ToString()));
            ...
            ada2.FillByManagerID(affs, int.Parse(Session["EmployeeIDFromSM"].ToString()), int.Parse(Session["CycleIDFromSM"].ToString()));
