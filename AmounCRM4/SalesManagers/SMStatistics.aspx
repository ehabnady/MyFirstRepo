<%@ Page Title="Calls Analysis" Language="C#" MasterPageFile="~/SalesManagers/SiteMaster2.Master" AutoEventWireup="true" CodeBehind="SMStatistics.aspx.cs" Inherits="AmounCRM4.SalesManagers.SMStatistics" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
                ...
                <td width="96%" align="center">
                    ...
                    <telerik:RadAjaxPanel ID="ajaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Width="100%">
                        <telerik:RadPivotGrid ID="RadPivotGrid1" runat="server" RenderMode="Lightweight" Width="100%" Height="700px" DataSourceID="ObjectDataSource21"
                            ...
                            <PagerStyle ChangePageSizeButtonToolTip="Change Page Size" PageSizeControlType="RadDropDownList" Mode="NextPrevNumericAndAdvanced" />
    ...
    <asp:ObjectDataSource ID="ObjectDataSource21" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetDataBy_SMID"
