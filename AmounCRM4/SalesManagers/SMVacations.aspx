<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="SMVacations.aspx.cs" Inherits="AmounCRM4.SalesManagers.SMVacations" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    ...
    <asp:SqlDataSource ID="dsVac" runat="server" ConnectionString="<%$ ConnectionStrings:AmounCrmConnectionString %>" SelectCommand="SELECT * FROM [View_EmployeesVacations] WHERE ([TopManagerID] = @TopManagerID)">
        <SelectParameters>
            <asp:SessionParameter Name="TopManagerID" SessionField="EmployeeIDFromSM" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
</asp:Content>
