...
namespace AmounCRM4.SalesManagers
{
    public partial class Calls2 : System.Web.UI.Page
    {
        ...
        private void postCallEditPrep()
        {
            ...
            for (int iii = 0; iii < chklPro1PostCalls1.Items.Count; iii++)
            {
                if (!chklPro1PostCalls1.Items[iii].Selected)
                {
                    chklPro1PostCalls1.Items[iii].Attributes.Add("style","display:none");
                }
            }
            for (int iii = 0; iii < chklPro2PostCalls2.Items.Count; iii++)
            {
                if (!chklPro2PostCalls2.Items[iii].Selected)
                {
                    chklPro2PostCalls2.Items[iii].Attributes.Add("style", "display:none");
                }
            }
            for (int iii = 0; iii < chklPro3PostCalls3.Items.Count; iii++)
            {
                if (!chklPro3PostCalls3.Items[iii].Selected)
                {
                    chklPro3PostCalls3.Items[iii].Attributes.Add("style", "display:none");
                }
            }
        ...
        private void nextCallEditPrep()
        {
            ...
            for (int iii = 0; iii < chklPro1NextCallObjective1.Items.Count; iii++)
            {
                if (!chklPro1NextCallObjective1.Items[iii].Selected)
                {
                    chklPro1NextCallObjective1.Items[iii].Attributes.Add("style", "display:none");
                }
            }
            for (int iii = 0; iii < chklPro2NextCallObjective2.Items.Count; iii++)
            {
                if (!chklPro2NextCallObjective2.Items[iii].Selected)
                {
                    chklPro2NextCallObjective2.Items[iii].Attributes.Add("style", "display:none");
                }
            }
            for (int iii = 0; iii < chklPro3NextCallObjective3.Items.Count; iii++)
            {
                if (!chklPro3NextCallObjective3.Items[iii].Selected)
                {
                    chklPro3NextCallObjective3.Items[iii].Attributes.Add("style", "display:none");
                }
            }
            //End Of Visit Post Call Edit Preparation
        }
        ...
        private void samplesEditPrep()
        {
            ...
            //for (int iii = 0; iii < rep1Pro1Samples1.Items.Count; iii++)
            //{
            //    if (rep)
            //    {
