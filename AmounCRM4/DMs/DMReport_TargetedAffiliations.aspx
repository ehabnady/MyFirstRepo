<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="DMReport_TargetedAffiliations.aspx.cs" Inherits="AmounCRM4.DMs.DMReport_TargetedAffiliations" %>
                    ...
                    <telerik:RadGrid ID="gridAffs" runat="server" DataSourceID="ListOfTargetedAffDS" AllowFilteringByColumn="True" AllowPaging="True" Height="600px"
                        ...
                        <MasterTableView DataSourceID="ListOfTargetedAffDS" AutoGenerateColumns="False" ShowHeader="true" ShowGroupFooter="true" AllowPaging="true"
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="CycleDesc" Visible="true" FilterControlAltText="Filter CycleDesc column" HeaderText="CycleDesc" SortExpression="CycleDesc" UniqueName="CycleDesc"></telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="EmployeeName" Visible="true" FilterControlAltText="Filter EmployeeName column" HeaderText="EmployeeName" SortExpression="EmployeeName" UniqueName="EmployeeName"></telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="AmounTerritoryName" Visible="true" FilterControlAltText="Filter AmounTerritoryName column" HeaderText="Rep Area" SortExpression="AmounTerritoryName" UniqueName="AmounTerritoryName"></telerik:GridBoundColumn>
                            </Columns>
                        </MasterTableView>
                    </telerik:RadGrid>

                    <asp:SqlDataSource ID="ListOfTargetedAffDS" runat="server" ConnectionString="<%$ ConnectionStrings:AmounCrmConnectionString %>"
                        SelectCommand="SELECT AffiliationID, AffiliationName, AffiliationAddress, SpecialtyCode, TotalValue, AffiliationClass, BrickID, BrickName, CycleDesc, EmployeeName, AmounTerritoryName FROM View_TargetedAffiliations WHERE SupervisorID = @EmployeeIDFromDM">
                        <SelectParameters>
                            <asp:SessionParameter Name="EmployeeIDFromDM" SessionField="EmployeeIDFromDM" Type="Int32" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}" 
                        SelectMethod="GetDataBySuperTargetedAffs" TypeName="AmounCRM4.App_Data.ExecSummary2TableAdapters.AffiliationsByAreaGroupBySpecTableAdapter">
                        <SelectParameters>
                            <asp:SessionParameter Name="EmployeeIDFromDM" SessionField="EmployeeIDFromDM" Type="Int32" />
                        </SelectParameters>
