<%@ Page Title="Calls Analysis" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="DMStatistics.aspx.cs" Inherits="AmounCRM4.DMs.DMStatistics" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    ...
    <asp:ObjectDataSource ID="ObjectDataSource21" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetDataBy_DMID"
